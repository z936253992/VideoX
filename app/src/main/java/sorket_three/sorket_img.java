...
import greendao_three.greedao_use;
...
public class sorket_img {
    ...
    int iss;//判断消息来源
    Context context;
    public sorket_img(Handler handler){
        ...
        mThreadPool.execute(new Runnable() {
            ...
            public void run() {
                    try {
                        ...
                        while (true) {
                            socket = new Socket("120.77.39.76", 51000);
                            ...
                            try {
                                if ((response=br.readLine()).equals(">@")) {
                                    ...
                                    while ((response = br.readLine()) != null) {
                                        ...
                                        if (response.equals(">@#")) {
                                            runs();
                                            Log.d("ssss3", "kokokokokokokokoko");
                                        } else {
                                            img = img + '\n' + response;
                                        }
                                    }
